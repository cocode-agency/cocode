...
export interface SettingsScope<T> {
  ...
  /**
   * Reload this namespace from the Host document.
   *
   * Host-backed scopes share the settings domain's describe mirror, so this
   * call coalesces with any in-flight read. Memory-backed scopes resolve
   * immediately because they have no durable Host document to reload.
   */
  load(): Promise<void>
  /**
