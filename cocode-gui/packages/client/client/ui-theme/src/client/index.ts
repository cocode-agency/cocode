...
export function apply(ctx: ClientContext): void {
  // The component-local CSS modules cover individual surfaces, while these
  // sheets provide the shared --dsw-* token layer consumed by every DSH view.
  // Install them from the plugin lifecycle so Electron/web compositions get
  // the same styles and unloading a dynamic bundle removes its own tags.
