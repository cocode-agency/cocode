...
export const zh = {
  ...
  'time.years': '{n}年',
  'time.ago': '{t}前',
  'settings.storage.title': '会话存储位置',
  'settings.storage.description': '没有工作区的会话将使用此目录存储。',
  'settings.storage.systemDefault': '系统默认',
  'settings.storage.choose': '选择目录',
...
export const en = {
  ...
  'time.years': '{n}y',
  'time.ago': '{t} ago',
  'settings.storage.title': 'Session storage location',
  'settings.storage.description': 'Sessions without a workspace are stored in this directory.',
  'settings.storage.systemDefault': 'System default',
  'settings.storage.choose': 'Choose directory',
