 ...
 */
export const MarkdownText = memo(function MarkdownText({ text, streaming = false, codeLabels, fileMentions, className }: {
  text: string
  streaming?: boolean
  codeLabels?: MarkdownCodeLabels | undefined
  fileMentions?: MarkdownFileMentions | undefined
  /** Optional consumer-owned class for scoped typography or layout overrides. */
  ...
  return <div className={className === undefined ? css.markdown : `${css.markdown} ${className}`}>{children}</div>
})
