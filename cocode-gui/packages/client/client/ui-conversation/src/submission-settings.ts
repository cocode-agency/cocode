...
export const DEBUG_MODE_FIELD = 'debugMode'
...
/** Debug mode is opt-in so implementation details stay out of normal chats. */
...
export interface ConversationSettings {
  ...
  /** Whether low-level context injection rows are visible in the transcript. */
  debugMode: boolean
}
...
export const ConversationSettingsSchema: z<ConversationSettings> = z.object({
  ...
  [DEBUG_MODE_FIELD]: z.boolean().default(DEFAULT_DEBUG_MODE),
})
