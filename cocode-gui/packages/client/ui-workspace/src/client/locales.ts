...
export const zh = {
  ...
  'settings.storage.description': '未选择项目时，每个新会话会在此文件夹中使用独立目录。',
...
export const en = {
  ...
  'settings.storage.description': 'Each new chat without a project uses its own directory in this folder.',
