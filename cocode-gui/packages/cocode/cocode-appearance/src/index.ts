export const COCODE_APPEARANCE_PLUGIN = "cocode-appearance"

/** Host-side identity used by the DSH Loader when the package is included in boot. */
export const name = COCODE_APPEARANCE_PLUGIN

/** Appearance UI is client-only; the host entry has no service dependencies. */
