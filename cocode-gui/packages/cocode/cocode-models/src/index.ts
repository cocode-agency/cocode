export const COCODE_MODELS_PLUGIN = "cocode-models"

/** Host-side identity used by the DSH Loader when the package is included in boot. */
export const name = COCODE_MODELS_PLUGIN

/** Models UI is client-only; the host entry has no service dependencies. */
