export const COCODE_MESSAGE_FEEDBACK_PLUGIN = "cocode-message-feedback"

/** Host-side identity used by the DSH Loader when the package is included in boot. */
export const name = COCODE_MESSAGE_FEEDBACK_PLUGIN

/** Feedback UI is client-only; the host entry has no service dependencies. */
